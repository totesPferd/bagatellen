...
python3 -m dctbnbc.approach_a.gen_knowledge -a good_tl.json -b bad_tl.json >knowledge_a
python3 -m dctbnbc.approach_b.gen_knowledge -a good_tl.json -b bad_tl.json >knowledge_b
