...
package.loaded["logics.ql.Substitution"] =  Substitution
local Dict =  require "base.type.Dict"
local Skolem =  require "logics.ql.term.Skolem"
...
function Substitution:__diagnose_single_line(indentation)
   indentation:insert(String:string_factory("(logics::ql::Substitution"))
