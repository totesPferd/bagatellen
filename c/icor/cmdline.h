 ...
 *  @param argc taken from argc arg of main function which must exist in each C program
 *  @param argv taken from argv arg of main function which must exist in each C program
 ...
 *  *  -2 ... help screen;  don't step in action but do not take cmdline as erroneous
 */
int
